...
# Add hideDebtControls if needed or just handle it via statType
# The component already has 'statType' prop. 
# We should use 'statType === "debt"' to show those buttons.
...
# Add Profit Label to the last column
...
# Let's improve the availableYears calculation to be more robust
...
# We already increased width to 600px in the previous turn.
# Now let\'s re-design the grid inside.
