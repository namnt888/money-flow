...
async function updateSession(request) {
    ...
    if (!user && !request.nextUrl.pathname.startsWith('/login') && !request.nextUrl.pathname.startsWith('/auth') && !request.nextUrl.pathname.startsWith('/api/bot') && !request.nextUrl.pathname.startsWith('/api/migrate')) {
