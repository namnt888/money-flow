...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$data$3a$eac35a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/services/data:eac35a [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$data$3a$a4134a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/services/data:a4134a [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$data$3a$4ea58b__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/actions/data:4ea58b [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$data$3a$357431__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/actions/data:357431 [app-client] (ecmascript) <text/javascript>");
...
const UnifiedTransactionTable = /*#__PURE__*/ _s(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_577207839b545f50e0fdb06bbee3ea77$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].forwardRef(_c = _s(({ data, transactions, accountType, accountId, contextId, selectedTxnIds, onSelectionChange, onSelectTxn, onSelectAll, accounts = [], categories = [], people = [], shops = [], activeTab, hiddenColumns = [], columnOrder, onBulkActionStateChange, sortState: externalSortState, onSortChange, context, isExcelMode = false, showPagination = true, currentPage: propCurrentPage, totalPages, pageSize: propPageSize, onPageChange, onPageSizeChange, fontSize: externalFontSize, onFontSizeChange, onEdit: externalOnEdit, onDuplicate: externalOnDuplicate, onSuccess, loadingIds, setIsGlobalLoading, setLoadingMessage, searchQuery, hideFilters = false, compact = false }, ref)=>{
    ...
    const handleRestore = async (txn)=>{
        setIsRestoring(true);
        try {
            const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$data$3a$357431__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["restoreTransaction"])(txn.id);
            if (!ok) {
    ...
    const handleVoidConfirm = async ()=>{
        ...
        try {
            const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$data$3a$4ea58b__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["voidTransactionAction"])(targetId);
            if (!ok) {
    ...
    const handleSingleDeleteConfirm = async ()=>{
        ...
        try {
            const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$data$3a$eac35a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteTransaction"])(confirmDeletingTarget.id);
            if (ok) {
    ...
    const handleOpenLinkedDebt = async (id, e)=>{
        e.stopPropagation();
        try {
            const txn = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$data$3a$a4134a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getTransactionById"])(id);
            if (txn) {
                setEditingTxn(txn);
            } else {
    ...
    const executeBulk = async (mode)=>{
        ...
        if (mode === "void") {
            ...
            for (const id of processIds){
                ...
                try {
                    const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$data$3a$4ea58b__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["voidTransactionAction"])(id);
                    if (ok) {
                        setStatusOverrides((prev)=>({
                                ...prev,
                                [id]: "void"
            ...
            for (const id of processIds){
                ...
                const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$data$3a$357431__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["restoreTransaction"])(id);
                if (ok) {
                    setStatusOverrides((prev)=>({
                            ...prev,
                            [id]: "posted"
            ...
            for (const id of processIds){
                ...
                const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$data$3a$eac35a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteTransaction"])(id);
                if (!ok) {
                    errorCount++;
                }
                setUpdatingTxnIds((prev)=>{
