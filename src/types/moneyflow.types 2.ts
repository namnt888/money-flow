...
export type Person = {
  ...
  current_cycle_base_lend?: number | null;
  current_cycle_cashback?: number | null;
  current_cycle_repaid?: number | null;
  current_cycle_net_lend?: number | null;
  current_debt_balance?: number | null;
  past_due_count?: number | null;
  cycle_stats?: PersonCycleStats[];
  metadata?: any;
};
...
export type CashbackEntry =
  Database["public"]["Tables"]["cashback_entries"]["Row"];
export type CashbackCycle =
  Database["public"]["Tables"]["cashback_cycles"]["Row"];
