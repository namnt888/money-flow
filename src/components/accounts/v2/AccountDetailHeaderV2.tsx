...
import { getCategoryIcon } from "@/lib/category-icon"; // Added missing import
    ...
    const values = Array.from(
      new Set(
        fallbackRules
          ...
          .filter((minSpend: number) => !isSimpleCard || minSpend > 0),
      ),
    ).sort((a, b) => (a as number) - (b as number));

    const tabs = values.map((minSpend: any, idx: number) => {
      const mSpend = Number(minSpend);
      const matchingRules = fallbackRules.filter((rule: any) => Number(rule?.minSpend || 0) === mSpend);
      const topRule = matchingRules[0];
      const rateText = `${toDisplayPercent(topRule?.rate || 0)}%`;
      const tierText = isSimpleCard
        ? `${formatVNShort(mSpend)}+`
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 w-full">
      <div className="flex xl:flex-row flex-col gap-6">
        {/* Section 1: Account Info (20%) */}
        <div className="flex flex-col w-full xl:w-[20%] h-full justify-between">
          ...
          {isExpanded && (
            <div className="flex flex-col mt-auto">
              ...
              <PopoverContent side="top" className="w-[300px] p-0 border border-slate-200 shadow-2xl rounded-2xl overflow-hidden bg-white z-[120]">
            ...
            <div className="flex flex-col">
              <div className="text-[10px] font-bold uppercase text-slate-500 tracking-wider mb-1 whitespace-nowrap flex items-center">
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Info className="inline h-3 w-3 text-slate-300 ml-1 cursor-help" />
                    </TooltipTrigger>
                    <TooltipContent><p>Total available balance across family</p></TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
              ...
              <div className="text-[10px] font-bold uppercase text-slate-500 tracking-wider mb-1 whitespace-nowrap flex items-center">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent><p>Individual card available balance</p></TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
              ...
              <div className="text-[10px] font-bold uppercase text-slate-500 tracking-wider mb-1 whitespace-nowrap flex items-center">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent><p>Total credit limit</p></TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
        ...
        {/* Section 3: Performance (55%) */}
        <div className="flex flex-col w-full xl:w-[55%] xl:border-l border-dashed border-slate-300 xl:pl-6 h-full">
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                <TooltipProvider>
                  <Tooltip delayDuration={200}>
                    ...
                    <TooltipContent side="bottom" className="w-[600px] p-0 border border-slate-200 shadow-[0_40px_100px_rgba(0,0,0,0.3)] rounded-[2rem] overflow-hidden bg-white z-[120]" sideOffset={15}>
                ...
                <button
                  ...
                  className="flex items-center justify-center w-8 h-8 rounded-full border border-slate-200 bg-white text-slate-500 hover:text-slate-900 hover:bg-slate-50 transition-all"
                >
              ...
              <div className="text-[10px] font-bold uppercase text-slate-500 tracking-wider mb-1 whitespace-nowrap flex items-center">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent><p>Total profit after sharing</p></TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
              ...
              <div className="text-[10px] font-bold uppercase text-slate-500 tracking-wider mb-1 whitespace-nowrap flex items-center">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent><p>Cashback already claimed</p></TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
              ...
              <div className="text-[10px] font-bold uppercase text-slate-500 tracking-wider mb-1 whitespace-nowrap flex items-center">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent><p>Estimated cashback based on rules</p></TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
              ...
              <div className="text-[10px] font-bold uppercase text-slate-500 tracking-wider mb-1 whitespace-nowrap flex items-center">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent><p>Actual cashback earned</p></TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
              ...
              <div className="text-[10px] font-bold uppercase text-slate-500 tracking-wider mb-1 whitespace-nowrap flex items-center">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent><p>Cashback shared with family members</p></TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
